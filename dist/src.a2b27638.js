...
function expandArticleBody() {
  ...
  var allBtns = document.querySelectorAll(".expand_button");
  allBtns.forEach(function (btn) {
    btn.addEventListener("click", function (event) {
      var button = event.target;
      var article = button.parentNode.parentNode.parentNode;
      if (btn.innerText == "V") {
...
function highlightArticle() {
  // your code here
  var allBtns = document.querySelectorAll(".highlightBtn");
  allBtns.forEach(function (btn) {
    btn.addEventListener("click", function (event) {
      var button = event.target;
      var article = button.parentNode.parentNode.parentNode;
